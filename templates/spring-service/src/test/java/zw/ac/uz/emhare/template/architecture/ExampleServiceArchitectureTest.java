package zw.ac.uz.emhare.template.architecture;
...
/** Canonical package-boundary tests copied with every service. @author Tinashe K */
@AnalyzeClasses(packages = "zw.ac.uz.emhare.template", importOptions = ImportOption.DoNotIncludeTests.class)
class ExampleServiceArchitectureTest {

    @ArchTest
    static final ArchRule DOMAIN_ISOLATION = EmhareArchitectureRules.domainMustNotDependOnTransportOrMessaging();
    ...
    @ArchTest
    static final ArchRule SERVICE_BOUNDARY = EmhareArchitectureRules.serviceMustNotImportAnotherBusinessService(
            "zw.ac.uz.emhare.template");
