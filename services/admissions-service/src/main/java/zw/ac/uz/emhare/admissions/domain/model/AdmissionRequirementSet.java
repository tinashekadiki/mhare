...
public class AdmissionRequirementSet extends AuditableEntity {
    ...
    public AdmissionRequirementSet(UUID programmeId, ApplicationType applicationType, AdmissionCycle admissionCycle, String versionCode, LocalDate effectiveFrom) {
    ...
    public BigDecimal getMaleCutoffPoints() { return maleCutoffPoints; }
    public BigDecimal getFemaleCutoffPoints() { return femaleCutoffPoints; }
    public boolean isRequiresEnglish() { return requiresEnglish; }
    public boolean isRequiresMathematicsOrScience() { return requiresMathematicsOrScience; }
    public String getAdvancedRulesVersion() { return advancedRulesVersion; }
    public String getAdvancedRulesJson() { return advancedRulesJson; }
