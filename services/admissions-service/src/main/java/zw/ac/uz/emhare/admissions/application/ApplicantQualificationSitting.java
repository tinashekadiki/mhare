...
public class ApplicantQualificationSitting extends AuditableEntity {
    ...
    public ApplicantQualificationSitting(Application application, QualificationLevel level, ExamBody examBody, String centreNumber, String candidateNumber, Integer yearWritten) {
    ...
    public void update(ExamBody examBody, String institutionName, String centreNumber,
                       String candidateNumber, Integer yearWritten, UUID countryId, UUID documentId) {
        requireEditable();
        this.examBody = examBody;
        this.institutionName = optional(institutionName);
    ...
    public void reject(UUID actorUserId, String reason, Instant now) {
        if (reason == null || reason.isBlank()) throw new IllegalArgumentException("Qualification rejection reason is required.");
    ...
    public String getCentreNumber() { return centreNumber; }
    ...
    public QualificationResultStatus getVerificationStatus() { return verificationStatus; }
