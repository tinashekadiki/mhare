...
public class AdmissionOffer extends AuditableEntity {
  ...
  public AdmissionOffer(
    ...
    if (offerType == OfferType.CONDITIONAL
        && (conditionsText == null || conditionsText.isBlank())) {
    ...
    this.conditionsText =
        conditionsText == null || conditionsText.isBlank() ? null : conditionsText.trim();
  ...
  public AdmissionOffer(
    ...
    if (programmeChoiceDecision.getDecision() != DecisionOutcome.ADMIT
      ...
      throw new IllegalArgumentException(
          "Direct offers require the admitted programme-choice decision.");
    }
    if (!application.getId().equals(programmeChoice.getApplication().getId())) {
      throw new IllegalArgumentException("Programme choice does not belong to the application.");
    }
  ...
  public void updateTerms(
    ...
    if (acceptanceDeadline == null
        || !acceptanceDeadline.isAfter(now)
        || commencementDate == null) {
      throw new IllegalArgumentException(
          "A future acceptance deadline and commencement date are required.");
    }
    if (offerType == OfferType.CONDITIONAL
        && (conditionsText == null || conditionsText.isBlank())) {
      throw new IllegalArgumentException("Conditional offers require conditions.");
    ...
    if (registrationDate != null && registrationDate.isAfter(commencementDate)
      ...
      throw new IllegalArgumentException(
          "Registration and orientation cannot be after commencement.");
    }
    this.offerType = offerType;
    this.conditionsText =
        conditionsText == null || conditionsText.isBlank() ? null : conditionsText.trim();
  ...
  public void publish(OfferPublication publication, UUID actorUserId, Instant now) {
    if (currentDocumentVersion == null
        || publication.getDocumentVersion() != currentDocumentVersion) {
  ...
  public void approve(UUID actorUserId, Instant now) {
    ...
    if (generatedDocumentId == null) {
      throw new IllegalStateException(
          "A stored generated offer document is required before approval.");
    }
  ...
  public void linkGeneratedDocument(UUID documentId) {
    if (documentId == null)
      throw new IllegalArgumentException("Generated offer document is required.");
  ...
  public void respond(OfferResponseType response) {
    ...
    if (currentPublication == null || amendmentPending) {
      throw new IllegalStateException(
          "The current offer document must be published before responding.");
    }
  ...
  public void markConverted(
      UUID conversionRequestId, UUID studentId, String studentNumber, Instant now) {
    ...
    if (conversionRequestId == null
      ...
      throw new IllegalArgumentException(
          "Conversion request and student identifiers are required.");
    }
  ...
  public OfferBatch getOfferBatch() {
    return offerBatch;
  }

  public ProgrammeChoiceDecision getProgrammeChoiceDecision() {
    return programmeChoiceDecision;
  }
  ...
  public String getOfferTypeCode() {
    return offerType == null ? null : offerType.name();
  }
  ...
  public OfferDocumentVersion getCurrentDocumentVersion() {
    return currentDocumentVersion;
  }

  public OfferPublication getCurrentPublication() {
    return currentPublication;
  }

  public boolean isAmendmentPending() {
    return amendmentPending;
  }
  ...
  public UUID getConversionEventId() {
    return conversionEventId;
  }
  ...
  public UUID getConvertedStudentId() {
    return convertedStudentId;
  }

  public String getConvertedStudentNumber() {
    return convertedStudentNumber;
  }
