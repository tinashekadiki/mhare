...
@Table(
    ...
    uniqueConstraints =
        @UniqueConstraint(
            name = "uk_grading_scale_values_scale_grade",
            columnNames = {"grading_scale_id", "grade"}))
public class GradingScaleValue extends AuditableEntity {
  ...
  public GradingScaleValue(
      GradingScale gradingScale, String grade, BigDecimal points, boolean pass, int sortOrder) {
