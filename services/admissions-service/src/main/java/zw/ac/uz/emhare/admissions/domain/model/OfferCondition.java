...
public class OfferCondition extends AuditableEntity {
  ...
  public OfferCondition(
      AdmissionOffer offer, String conditionCode, String description, boolean required) {
    if (conditionCode == null
        || conditionCode.isBlank()
        || description == null
        || description.isBlank()) {
  ...
  private void resolve(
      OfferConditionStatus resolution, UUID actorUserId, String notes, Instant now) {
  ...
  public OfferConditionStatus getStatus() {
    return status;
  }

  public UUID getSatisfiedByUserId() {
    return satisfiedByUserId;
  }
