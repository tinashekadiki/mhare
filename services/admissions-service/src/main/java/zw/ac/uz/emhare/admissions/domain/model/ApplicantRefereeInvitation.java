...
/** Secure invitation and confidential response supplied by an applicant-nominated referee. @author Tinashe K */
@Audited
@Entity
@Table(name = "applicant_referee_invitations")
public class ApplicantRefereeInvitation extends AuditableEntity {

    public enum Status { SENT, OPENED, SUBMITTED, REVOKED, EXPIRED }
    public enum Recommendation { STRONGLY_RECOMMEND, RECOMMEND, RECOMMEND_WITH_RESERVATIONS, DO_NOT_RECOMMEND }
    ...
    public void submit(
        ...
        if (!declarationAccepted) {
            throw new IllegalArgumentException("Confirm that this confidential reference is accurate before submitting.");
        }
    ...
    public ApplicationRefereeNomination getNomination() { return nomination; }
    ...
    public Integer getYearsKnown() { return yearsKnown; }
