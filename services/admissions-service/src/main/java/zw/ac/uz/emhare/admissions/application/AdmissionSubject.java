...
@Table(
        ...
        uniqueConstraints = @UniqueConstraint(name = "uk_admission_subjects_level_code", columnNames = {"level", "code"}))
public class AdmissionSubject extends AuditableEntity {
    ...
    public boolean isScienceSubject() { return scienceSubject; }
    public boolean isMathematicsSubject() { return "MATHEMATICS".equalsIgnoreCase(subjectGroupCode); }
    public boolean isEnglishSubject() { return "ENGLISH".equalsIgnoreCase(subjectGroupCode); }
