...
public class ApplicantEmploymentHistory extends AuditableEntity {
    ...
    public ApplicantEmploymentHistory(Applicant applicant, String employerName, String positionTitle,
                                      LocalDate startedOn, LocalDate endedOn, boolean current, String responsibilities) {
        this.applicant = applicant;
        update(employerName, positionTitle, startedOn, endedOn, current, responsibilities);
    }

    public void update(String employerName, String positionTitle, LocalDate startedOn,
                       LocalDate endedOn, boolean current, String responsibilities) {
