...
public class OfferResponse extends AuditableEntity {
    ...
    public OfferResponse(AdmissionOffer offer, OfferPublication offerPublication, OfferResponseType response,
            Instant respondedAt, UUID respondedByUserId, String notes) {
        this.offer = offer;
    ...
    public OfferResponseType getResponse() { return response; }
