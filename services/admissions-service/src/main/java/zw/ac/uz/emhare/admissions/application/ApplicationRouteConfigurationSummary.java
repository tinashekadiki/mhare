...
public record ApplicationRouteConfigurationSummary(
    ...
    public record ProgrammeMappingSummary(UUID programmeId, String programmeCode, String programmeName) { }

    public record DocumentRequirementSummary(
            String code, String name, boolean required, int sortOrder) { }
}
