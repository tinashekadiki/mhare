...
public class ApplicationSection extends AuditableEntity {
  ...
  public ApplicationSection(
      Application application, ApplicationTypeSection definition, boolean required) {
  ...
  public void recordStatus(ApplicationSectionStatus newStatus, String summary, Instant now) {
    ...
    completedAt =
        newStatus == ApplicationSectionStatus.COMPLETE
                || newStatus == ApplicationSectionStatus.VERIFIED
            ? now
            : null;
  }
  ...
  public ApplicationSectionStatus getStatus() {
    return status;
  }
  ...
  public boolean isComplete() {
    return status == ApplicationSectionStatus.COMPLETE
        || status == ApplicationSectionStatus.VERIFIED;
  }
}
