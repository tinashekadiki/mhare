...
public class OfferDispatch extends AuditableEntity {
  ...
  public OfferDispatch(
    ...
    this.providerMessageId =
        providerMessageId == null || providerMessageId.isBlank() ? null : providerMessageId.trim();
  ...
  public OfferDispatch(
      ...
      int attemptNumber,
      java.util.UUID notificationEventId,
      String sentTo,
      Instant queuedAt) {
    if (offer == null
        || publication == null
      ...
      throw new IllegalArgumentException(
          "Offer publication, delivery attempt, event and recipient are required.");
    }
    this.offer = offer;
  ...
  public void recordStatus(
      ...
      Instant occurredAt) {
    if (occurredAt == null)
      throw new IllegalArgumentException("Delivery evidence time is required.");
    ...
    this.providerMessageId =
        providerMessageId == null || providerMessageId.isBlank() ? null : providerMessageId.trim();
    this.failureReason =
        failureReason == null || failureReason.isBlank() ? null : failureReason.trim();
  ...
  public java.util.UUID getNotificationEventId() {
  ...
  public OfferDispatchStatus getStatus() {
    return status;
  }
