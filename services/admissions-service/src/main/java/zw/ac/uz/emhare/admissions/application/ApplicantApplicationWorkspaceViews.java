...
public final class ApplicantApplicationWorkspaceViews {
  ...
  public record ApplicationWorkspace(
      ...
      IdentityNameCorrectionSummary identityNameCorrection,
  ...
  public record ProgrammeEntryPreferenceSummary(
      ...
      UUID entryOptionId,
      String entryOptionCode,
      String entryOptionName,
      int preferenceRank) {}
  ...
  public record NextOfKinSummary(
    ...
    static NextOfKinSummary from(ApplicantNextOfKin value) {
      return new NextOfKinSummary(
          value.getId(),
          value.getFullName(),
          value.getRelationshipCode(),
  ...
  public record EmploymentHistorySummary(
    ...
    static EmploymentHistorySummary from(ApplicantEmploymentHistory value) {
      return new EmploymentHistorySummary(
          value.getId(),
          value.getEmployerName(),
          value.getPositionTitle(),
          value.getStartedOn(),
          value.getEndedOn(),
          value.isCurrent(),
  ...
  public record RefereeSummary(
    ...
    static RefereeSummary from(
      ...
      boolean submittedResponseVisible =
          includeConfidentialResponse
              && invitation != null
      ...
      return new RefereeSummary(
          ...
          value.getPositionTitle(),
          nomination.getExpertise(),
          nomination.getRelationshipToApplicant(),
          value.getEmail(),
          value.getPhoneNumber(),
          value.getVerificationStatus().name(),
          value.getReferenceDocumentId(),
  ...
  public record GradeReferenceOption(
      UUID id, String grade, BigDecimal points, boolean pass, int sortOrder, long version) {}
