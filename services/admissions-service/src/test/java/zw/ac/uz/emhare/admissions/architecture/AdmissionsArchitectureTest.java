...
@AnalyzeClasses(packages = "zw.ac.uz.emhare.admissions", importOptions = ImportOption.DoNotIncludeTests.class)
class AdmissionsArchitectureTest {
    ...
    static final ArchRule SERVICE_BOUNDARY =
            EmhareArchitectureRules.serviceMustNotImportAnotherBusinessService("zw.ac.uz.emhare.admissions");
