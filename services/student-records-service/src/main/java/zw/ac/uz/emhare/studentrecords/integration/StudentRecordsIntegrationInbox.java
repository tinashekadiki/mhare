...
/** @author Tinashe K */
@Component
public class StudentRecordsIntegrationInbox {
    private final JdbcTemplate jdbcTemplate;

    public StudentRecordsIntegrationInbox(JdbcTemplate jdbcTemplate) {
    ...
    public void markProcessed(UUID eventId, Instant processedAt) {
        ...
        if (updated != 1) throw new IllegalStateException("Claimed integration event could not be marked processed.");
    }
}
