...
public class AcademicRegistrationCatalogueClient {
    ...
    public RegistrationCatalogue getRegistrationCatalogue(
        ...
        try {
            RegistrationCatalogue catalogue = academicSetupRegistrationHttpService.getRegistrationCatalogue(
                    academicPeriodId, programmeVersionId, programmePeriodNumber);
            if (catalogue == null) {
