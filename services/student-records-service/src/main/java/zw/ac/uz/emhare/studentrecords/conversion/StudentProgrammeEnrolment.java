...
public class StudentProgrammeEnrolment extends AuditableEntity {
    ...
    public StudentProgrammeEnrolment(StudentProfile student, AcceptedOfferReadyForConversionEvent event) {
    ...
    public ProgrammeEnrolmentStatus getStatus() { return status; }
    public String getStatusReason() { return statusReason; }
    public Instant getApprovedAt() { return approvedAt; }
    public boolean isActive() { return status == ProgrammeEnrolmentStatus.ACTIVE; }
}
