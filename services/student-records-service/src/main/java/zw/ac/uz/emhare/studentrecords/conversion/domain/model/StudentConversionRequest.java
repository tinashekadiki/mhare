...
public class StudentConversionRequest extends AuditableEntity {
  ...
  public boolean recordFinanceProvisioning(boolean successful, String reason) {
    ...
    financeProvisioningStatus =
        successful ? ProvisioningStatus.COMPLETED : ProvisioningStatus.FAILED;
  ...
  public void complete(Instant now) {
    if (!canComplete())
      throw new IllegalStateException("Both provisioning operations must complete first.");
  ...
  public StudentProgrammeEnrolment getProgrammeEnrolment() {
    return programmeEnrolment;
  }

  public StudentConversionStatus getStatus() {
    return status;
  }

  public ProvisioningStatus getFinanceProvisioningStatus() {
    return financeProvisioningStatus;
  }

  public ProvisioningStatus getPortalProvisioningStatus() {
    return portalProvisioningStatus;
  }
  ...
  public UUID getLastRetryByUserId() {
    return lastRetryByUserId;
  }
