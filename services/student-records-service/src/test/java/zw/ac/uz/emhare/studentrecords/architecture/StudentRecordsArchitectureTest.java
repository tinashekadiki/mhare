...
@AnalyzeClasses(packages = "zw.ac.uz.emhare.studentrecords", importOptions = ImportOption.DoNotIncludeTests.class)
class StudentRecordsArchitectureTest {
    ...
    static final ArchRule SERVICE_BOUNDARY =
            EmhareArchitectureRules.serviceMustNotImportAnotherBusinessService("zw.ac.uz.emhare.studentrecords");
