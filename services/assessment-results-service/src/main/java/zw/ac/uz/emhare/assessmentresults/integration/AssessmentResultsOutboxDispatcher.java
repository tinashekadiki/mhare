...
/** @author Tinashe K */
@Component
public class AssessmentResultsOutboxDispatcher {

    private final AssessmentResultsOutboxEventRepository repository;
    private final RabbitTemplate rabbitTemplate;
    private final Clock clock;

    public AssessmentResultsOutboxDispatcher(
    ...
    public void dispatchPendingEvents() {
        ...
        List<AssessmentResultsOutboxEvent> events = repository.lockNextDispatchBatch(now);
        for (AssessmentResultsOutboxEvent event : events) {
            try {
