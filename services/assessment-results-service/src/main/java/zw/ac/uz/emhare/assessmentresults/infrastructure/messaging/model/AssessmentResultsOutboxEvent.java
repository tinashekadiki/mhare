package zw.ac.uz.emhare.assessmentresults.infrastructure.messaging.model;
...
public class AssessmentResultsOutboxEvent {
    ...
    protected AssessmentResultsOutboxEvent() {
    }

    public AssessmentResultsOutboxEvent(
            UUID id,
            String eventType,
            String routingKey,
            String payload,
    ...
    public void scheduleRetry(Instant now, RuntimeException exception) {
        ...
        lastError = exceptionMessage == null ? exception.getClass().getSimpleName() : exceptionMessage;
