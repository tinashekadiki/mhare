...
@AnalyzeClasses(packages = "zw.ac.uz.emhare.assessmentresults", importOptions = ImportOption.DoNotIncludeTests.class)
class AssessmentResultsArchitectureTest {
    ...
    static final ArchRule SERVICE_BOUNDARY =
            EmhareArchitectureRules.serviceMustNotImportAnotherBusinessService("zw.ac.uz.emhare.assessmentresults");
