...
/** @author Tinashe K */
final class DiningValues {
    private DiningValues() {}
    ...
    static void version(long actual, long expected, String label) {
        if (actual != expected) throw new IllegalStateException(label + " was changed by another operator. Refresh and try again.");
    }
}
