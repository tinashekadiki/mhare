...
public interface DiningWorkflowEventRepository extends JpaRepository<DiningWorkflowEvent,UUID>{List<DiningWorkflowEvent> findAllByDeletedAtIsNullOrderByOccurredAtDesc();}
