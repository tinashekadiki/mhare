...
public interface MealServiceTimeRepository extends JpaRepository<MealServiceTime, UUID> { List<MealServiceTime> findAllByDeletedAtIsNullOrderByDiningHallCodeAscDayOfWeekAscServiceOpensAtAsc(); }
