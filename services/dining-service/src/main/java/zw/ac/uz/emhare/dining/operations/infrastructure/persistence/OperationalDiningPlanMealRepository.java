...
public interface OperationalDiningPlanMealRepository extends JpaRepository<DiningPlanMeal,UUID>{Optional<DiningPlanMeal> findByDiningPlanIdAndMealOptionId(UUID planId,UUID mealOptionId);}
