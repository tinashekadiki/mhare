package zw.ac.uz.emhare.dining.architecture;
...
@AnalyzeClasses(
    packages = "zw.ac.uz.emhare.dining",
    importOptions = ImportOption.DoNotIncludeTests.class)
class DiningArchitectureTest {
  ...
  static final ArchRule SERVICE_BOUNDARY =
      EmhareArchitectureRules.serviceMustNotImportAnotherBusinessService("zw.ac.uz.emhare.dining");
