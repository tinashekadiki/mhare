...
@AnalyzeClasses(packages = "zw.ac.uz.emhare.coreidentity", importOptions = ImportOption.DoNotIncludeTests.class)
class CoreIdentityArchitectureTest {
    ...
    static final ArchRule SERVICE_BOUNDARY =
            EmhareArchitectureRules.serviceMustNotImportAnotherBusinessService("zw.ac.uz.emhare.coreidentity");
