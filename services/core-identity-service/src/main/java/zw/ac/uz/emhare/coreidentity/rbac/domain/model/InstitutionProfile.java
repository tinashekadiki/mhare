...
@Audited
@Entity
@Table(name = "institution_profile", uniqueConstraints = @UniqueConstraint(name = "uk_institution_profile_code", columnNames = "code"))
public class InstitutionProfile extends AuditableEntity {
    ...
    public InstitutionProfile(String code, String name, String legalName, String countryCode, String timezone) {
        this.code = code;
        this.name = name;
