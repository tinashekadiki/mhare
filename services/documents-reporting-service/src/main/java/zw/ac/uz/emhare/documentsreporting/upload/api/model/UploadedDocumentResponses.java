package zw.ac.uz.emhare.documentsreporting.upload.api.model;
 ...
 * @author Tinashe K
 */
public final class UploadedDocumentResponses {
  private UploadedDocumentResponses() {}
  ...
  public record VerifyUploadedDocument(
      @NotNull Long expectedVersion, @Size(max = 1000) String comment) {}

  public record RejectUploadedDocument(
      @NotNull Long expectedVersion, @NotBlank @Size(min = 10, max = 1000) String reason) {}
}
