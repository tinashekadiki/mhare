...
@AnalyzeClasses(packages = "zw.ac.uz.emhare.documentsreporting", importOptions = ImportOption.DoNotIncludeTests.class)
class DocumentsReportingArchitectureTest {
    ...
    static final ArchRule SERVICE_BOUNDARY =
            EmhareArchitectureRules.serviceMustNotImportAnotherBusinessService("zw.ac.uz.emhare.documentsreporting");
