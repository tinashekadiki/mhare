...
public final class NotificationValues {
    ...
    public static String code(String value, String field) { return required(value, field).toUpperCase().replace(' ', '_'); }
    ...
    public static void version(long actual, long expected, String record) {
