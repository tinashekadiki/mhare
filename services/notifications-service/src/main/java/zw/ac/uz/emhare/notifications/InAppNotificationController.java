...
import zw.ac.uz.emhare.notifications.NotificationContracts.InAppSummary;
import zw.ac.uz.emhare.notifications.NotificationContracts.MarkInAppRead;
...
public class InAppNotificationController {
    ...
    public InAppSummary markRead(
            ...
            @Valid @RequestBody MarkInAppRead command) {
        return notificationService.markInAppRead(notificationId, actor(authentication), command.expectedVersion());
    }
