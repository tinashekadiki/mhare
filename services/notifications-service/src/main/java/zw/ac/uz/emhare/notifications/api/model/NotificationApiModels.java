package zw.ac.uz.emhare.notifications.api.model;
...
public final class NotificationApiModels {
    ...
    public record QueueNotification(@NotBlank String idempotencyKey,@NotBlank String sourceService,UUID sourceEventId,@NotBlank String eventType,@NotBlank String templateCode,@NotNull NotificationTemplate.Channel channel,@NotBlank String locale,UUID recipientUserId,@NotBlank String recipientKey,@NotBlank String recipientAddress,@NotNull NotificationRequest.Priority priority,Instant scheduledAt,@Min(1) @Max(20) Integer maxAttempts,Map<String,String> variables,java.util.List<zw.ac.uz.emhare.common.messaging.NotificationAttachmentReference> attachments) {
        public QueueNotification(String idempotencyKey,String sourceService,UUID sourceEventId,String eventType,String templateCode,NotificationTemplate.Channel channel,String locale,UUID recipientUserId,String recipientKey,String recipientAddress,NotificationRequest.Priority priority,Instant scheduledAt,Integer maxAttempts,Map<String,String> variables){this(idempotencyKey,sourceService,sourceEventId,eventType,templateCode,channel,locale,recipientUserId,recipientKey,recipientAddress,priority,scheduledAt,maxAttempts,variables,java.util.List.of());}
    }
