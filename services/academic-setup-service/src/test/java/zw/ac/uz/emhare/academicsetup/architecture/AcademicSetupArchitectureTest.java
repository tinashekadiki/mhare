...
@AnalyzeClasses(packages = "zw.ac.uz.emhare.academicsetup", importOptions = ImportOption.DoNotIncludeTests.class)
class AcademicSetupArchitectureTest {
    ...
    static final ArchRule SERVICE_BOUNDARY =
            EmhareArchitectureRules.serviceMustNotImportAnotherBusinessService("zw.ac.uz.emhare.academicsetup");
