package zw.ac.uz.emhare.finance.payment.provider.api.model;
...
/** @author Tinashe K */
public final class ApplicationPaymentCheckoutResponses {
    private ApplicationPaymentCheckoutResponses() {
    }
