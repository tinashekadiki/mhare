package zw.ac.uz.emhare.finance.collections.api.model;
...
import java.time.*;
import java.util.*;
import zw.ac.uz.emhare.finance.collections.domain.model.StudentAccountPayment.PaymentChannel;

/** @author Tinashe K */
public final class FinanceCollectionsApiModels {
    private FinanceCollectionsApiModels() {}
