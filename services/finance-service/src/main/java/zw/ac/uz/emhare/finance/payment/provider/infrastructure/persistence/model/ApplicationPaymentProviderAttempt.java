...
public class ApplicationPaymentProviderAttempt extends AuditableEntity {
    ...
    public java.util.UUID getSourceApplicationId() { return sourceApplicationId; }
    public String getMerchantTrace() { return merchantTrace; }
    public String getMerchantReference() { return merchantReference; }
    public String getReturnNonceHash() { return returnNonceHash; }
    ...
    public void recordProviderReturn(
        ...
        this.providerTransactionReference = optionalLength(
                providerTransactionReference, 160, "Provider transaction reference");
        this.providerStatusCode = optionalLength(providerStatusCode, 30, "Provider status code");
        this.providerResultDescription = optionalLength(
                providerResultDescription, 500, "Provider result description");
