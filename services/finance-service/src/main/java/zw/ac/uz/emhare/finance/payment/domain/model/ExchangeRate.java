...
public class ExchangeRate extends AuditableEntity {
  ...
  public ExchangeRate(
    ...
    if ("USD".equals(this.sourceCurrencyCode)) {
      throw new IllegalArgumentException(
          "An exchange rate is not required for USD base-currency transactions.");
    }
    ...
    this.preparedByUserId =
        java.util.Objects.requireNonNull(preparedByUserId, "Exchange-rate preparer is required.");
  ...
  public void approve(UUID actorUserId, Instant approvedAt, String reason) {
    ...
    if (actorUserId == null || approvedAt == null) {
      throw new IllegalArgumentException(
          "Exchange-rate approval actor and timestamp are required.");
    }
    if (actorUserId.equals(preparedByUserId)) {
      throw new IllegalStateException(
          "Exchange-rate approval requires a different Finance operator.");
    }
  ...
  public void retire(UUID actorUserId, Instant retiredAt, String reason) {
    ...
    this.retiredByUserId =
        java.util.Objects.requireNonNull(
            actorUserId, "Exchange-rate retirement actor is required.");
    this.retiredAt =
        java.util.Objects.requireNonNull(
            retiredAt, "Exchange-rate retirement timestamp is required.");
  ...
  public UUID getRetiredByUserId() {
    return retiredByUserId;
  }
