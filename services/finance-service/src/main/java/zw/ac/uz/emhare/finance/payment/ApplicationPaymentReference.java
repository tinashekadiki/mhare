...
@Table(
        ...
        uniqueConstraints = {
            @UniqueConstraint(name = "uk_application_payment_references_application", columnNames = "source_application_id"),
            @UniqueConstraint(name = "uk_application_payment_references_reference", columnNames = "reference")
        })
