package zw.ac.uz.emhare.finance.architecture;
...
@AnalyzeClasses(
    packages = "zw.ac.uz.emhare.finance",
...
class FinanceArchitectureTest {
  ...
  static final ArchRule SERVICE_BOUNDARY =
      EmhareArchitectureRules.serviceMustNotImportAnotherBusinessService("zw.ac.uz.emhare.finance");
