...
public class GatewaySecurityConfiguration {
  ...
  @Bean
  @Order(1)
  SecurityFilterChain applicationPaymentReturnSecurityFilterChain(HttpSecurity http)
      throws Exception {
        ...
        .authorizeHttpRequests(
            authorize ->
                authorize
                    ...
                    .permitAll()
                    .requestMatchers("/api/admissions/referee-references/**")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/communications/public/**")
                    .permitAll()
                    .requestMatchers(HttpMethod.POST, "/api/notifications/provider-callbacks/**")
                    .permitAll()
  ...
  CorsConfigurationSource gatewayCorsConfigurationSource(
      @Value(
              "${emhare.gateway.cors.allowed-origins:http://localhost:3000,http://localhost:3001,http://localhost:3002,http://localhost:3100,http://localhost:3101,http://localhost:3102}")
  ...
  FilterRegistrationBean<CorsFilter> gatewayCorsFilter(
    ...
    FilterRegistrationBean<CorsFilter> registrationBean =
        new FilterRegistrationBean<>(new CorsFilter(gatewayCorsConfigurationSource));
