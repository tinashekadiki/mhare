package zw.ac.uz.emhare.communications.architecture;
...
@AnalyzeClasses(
    packages = "zw.ac.uz.emhare.communications",
    importOptions = ImportOption.DoNotIncludeTests.class)
class CommunicationsArchitectureTest {
  ...
  @ArchTest
  static final ArchRule DOMAIN_LAYERING =
      EmhareArchitectureRules.domainMustNotDependOnOuterLayers();
  ...
  @ArchTest
  static final ArchRule SOFT_DELETE_ENFORCEMENT =
      EmhareArchitectureRules.auditableEntitiesMustEnforceSoftDelete();
  ...
  static final ArchRule SERVICE_BOUNDARY =
      EmhareArchitectureRules.serviceMustNotImportAnotherBusinessService(
          "zw.ac.uz.emhare.communications");

  @ArchTest
  static final ArchRule CONTROLLER_LOCATION =
      EmhareArchitectureRules.controllersMustResideInApiControllerPackages();
  ...
  @ArchTest
  static final ArchRule COMMAND_LOCATION =
      EmhareArchitectureRules.commandsMustResideInApplicationCommandPackages();
