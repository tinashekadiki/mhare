...
<template>
  ...
  <EmhareRecordDrawer v-model:open="drawerOpen" presentation="page" :title="drawerTitle" description="Complete the controlled record. Updates require the current optimistic-lock version." :busy="saving" :submit-disabled="saving" @submit="saveRecord">
