...
<template>
  ...
  <EmhareRecordDrawer v-model:open="drawerOpen" presentation="page" :title="drawerTitle" description="Complete the controlled operation. State-changing actions require explicit evidence." :busy="saving" :submit-label="drawerMode === 'attendance' ? 'Evaluate access' : drawerMode === 'reconcile' ? 'Reconcile session' : 'Save record'" :submit-icon="drawerMode === 'attendance' ? 'i-lucide-scan-line' : 'i-lucide-save'" @submit="submitDrawer">
