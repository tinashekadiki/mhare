...
class EmhareApiExceptionHandlerTest {
    ...
    private final MockHttpServletRequest request = new MockHttpServletRequest("POST", "/api/admissions/applications");
    ...
    void handleInvalidRequest_shouldReturnSafeCorrelatedProblemDetail() {
        ProblemDetail problemDetail = exceptionHandler.handleInvalidRequest(
                new IllegalArgumentException("Admission cycle not found."),
                request);
